...
export const UpdateUIProps = ({ propValue,}: UpdateUIPropsType) => {
...
//   const [arrayV, setArrayValue] = useState<number[]>([]);
  ...
  return (
    <>
      <button className="bg-blue-400 p-2 rounded-md" onClick={increment}>Increment</button>
      {value}
      <button className="bg-red-400 p-2 rounded-md" onClick={decrement}>Decrement</button>
    </>
  );
};